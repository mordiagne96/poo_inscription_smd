...
<!-- <?= var_dump($_SESSION['user']); ?> -->
  ...
  <div class='container container-fluid'>
      ...
      <div class='container-fluid d-flex justify-content-between bg-gradient-primary' style="padding:1vh;color:white;font-size:2rem;">
        <a href="#" class="">
                <button class="btn btn-circle bg-gradient-success pulse" id="new_element" data-name="inscription" ><i class="fa fa-plus"></i></button>
        </a>
      ...
      <table class="table table-striped table-bordered" data-name="inscription">
      ...
      <div class="hide form-insc slideExpandUp" >
                <form id="form-inscription-etu"style="display: flex; gap:4vh; padding:3vh;" class="bg-gray-200 position-relative" method="post" enctype="multipart/form-data" action="<?= $url_base ?>Professeur/add">
                    <input type="hidden" name="add-professeur-fetch">
                    <div style="width:60%;">
                        <label><h3>Information Etudiant</h3></label>

                        <div class="mb-3 row">
                            <label for="inputName" class="col-sm-1-12 col-form-label">Matricule</label>
                            <div class="col-sm-1-12">
                                <input type="text" class="form-control" name="matricule" id="" placeholder="Matricule" readonly>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="inputName" class="col-sm-1-12 col-form-label">Nom Complet</label>
                            <div class="col-sm-1-12">
                                <input type="text" class="form-control" name="nomComplet" id="" placeholder="">
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            <label for="inputName" class="col-sm-1-12 col-form-label">Login/Email</label>
                            <div class="col-sm-1-12">
                                <input type="email" class="form-control" name="login" id="" placeholder="">
                            </div>
                        </div>
                    ...
                    <!-- classe -->
                    <div class="d-flex flex-column mb-3 info-classe" style="width:40%;">
                        <label for="" class="form-label"><h3>Classe</h3></label></br>
                        <div class="mb-3">
                            <label for="" class="form-label">Selectionner la classe</label>
                            <select class="form-select select-classe" name="idClasse" id="">
                    ...
                    <div class="position-absolute bottom-0 start-50 translate-middle-x d-flex justify-content-evenly" style="gap:2vh;">
                        <button type="submit" name="ajout-inscription-etu" value="ajouter_inscription" class="btn btn-primary">Ajouter</button>
